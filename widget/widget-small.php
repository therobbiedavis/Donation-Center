...
<link type="text/css" href="widget-small.css?19" rel="Stylesheet" />
...
<div id="widgetContainer">
	...
	<div class="donateimg">
		...
		<a href="<? echo $charity_url; ?>" target="_blank"><img src="<? echo $image_url?>" width="60" alt="Donate"/></a>
...
<?php
  ...
  $file = fopen('/home/tsgadmin/public_html/donate.thespeedgamers.com/widget/cache/widget-small.'.$id.'.cache', 'w');
  fwrite($file, $output);
  fclose($file);
?>