<?php
	...
	if ($id[0] == NULL) {
	mysql_query("INSERT INTO stats (hour, don_total, don_diff, event_id) VALUES (".$nextt.", 0, 0, ".$eventid.")");
	} else {
   mysql_query("INSERT INTO stats (hour, don_total, don_diff, event_id) VALUES (".$nextt.", ".$donationtotal.", ".$donationdiff.", ".$eventid.")");
	}	
    echo mysql_error();
?>